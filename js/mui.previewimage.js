(function($, window) {
	...
	var imgId = 0;
	var PreviewImage = function(openFunction,closeFunction) {
...
//		this.empty();
	...
	$.previewImage = function(openFunction,closeFunction) {
		if (!previewImageApi) {
			previewImageApi = new PreviewImage(openFunction,closeFunction);
		}
